...
e.preventDefault()
  ...
  return (
    ...
    >
      ...
      <input type="email" className='w-full px-3 py-2 border border-gray-800' placeholder='Enter email' />
      <input type="password" className='w-full px-3 py-2 border border-gray-800' placeholder='Enter password' />
